CREATE DATABASE IF NOT EXISTS `caltex_duc`;
USE `caltex_duc`;
...
CREATE TABLE IF NOT EXISTS `nozzle_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `dispenser_id` varchar(50) NOT NULL,
  `nozzle_id` varchar(50) NOT NULL,
  `product` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `atg_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `address` varchar(50) NOT NULL,
  `status` tinyint NOT NULL DEFAULT '0',
  `temp` decimal(10,2) NOT NULL DEFAULT '0.00',
  `product_level` decimal(15,2) NOT NULL DEFAULT '0.00',
  `water_level` decimal(15,2) NOT NULL DEFAULT '0.00',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_atg_history` (`address`)
) ENGINE=InnoDB;
